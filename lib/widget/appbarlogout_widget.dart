...
AppBar buildAppBarLogout(BuildContext context, String title) {
  return AppBar(
    iconTheme:
...
Future<void> _logoutConfirmationDialog(BuildContext context) async {
...
Future<void> logoutsuper(BuildContext context) async {
